...
VariableTypeDefinition <- VariableDefinitionStart ':' (CallableSignature / TypesDefinition)
...
VariableAccessType <- 'let' / 'set' / 'const' / 'constexpr'
...
TypesItem <- TypeMemoryType? TypePointerType* (TypesConstDefinition / TypeArray)
TypesConstDefinition <- 'const' TypeArray
